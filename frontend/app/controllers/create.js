...
export default Ember.Controller.extend({
    ...
    //
		...
		loadMore() {
			...
			let url = config.serverPath + 'articles/?tag=Create&per_page='+this.get('perPage')+'&page='+(page+1);
			console.log('@@@@ Load more create: ',count,' page: ',page,' total: ',this.get('model.pagination')[0].total_pages,' url: ',url)
