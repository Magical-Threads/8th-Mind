define('ember-social/components/twitter-card', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    createTwitterCard: _ember['default'].on('twitterLoaded', function () {
      ...
      if (tweetId) {
        this.twttr.widgets.createTweet(tweetId, this.get('element'), {
          ...
          _ember['default'].Logger.debug('Twitter Embedded Tweet inserted.');
        });
      }
    })
  });
