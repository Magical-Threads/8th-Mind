				...
				<div class="col-md-offset-2 col-md-8">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form"> 
							<form class="form-horizontal" id="edit_user" method="post" action="<?php echo base_url(); ?>user/edit_pass_code/<?php echo $staff->userID; ?>" enctype="multipart/form-data" role="form">
