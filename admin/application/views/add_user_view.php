				...
				<div class="col-md-offset-2 col-md-8">
					...
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add User Information
							</div>
							<div class="tools">
						...
						<div class="portlet-body form"> 
							<form class="form-horizontal" id="add_user" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/add_access" role="form">
    ...
    form3.validate({
                ...
                rules: {
                    ...
                    userEmail: {
                        required: true,
                        email: true,
                        remote:"<?=base_url()?>user/email_checks"
                           },
                    userPassword:{                       
                        required: true,                        
                        minlength:8                         
