				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Staffs
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?=base_url()?>staff/add"><button id="sample_editable_1_new" class="btn green">
							...
							<tr class="odd gradeX">
                                ...
                                <td class="center">
                                  <a href="<?php echo base_url();?>staff/reset_password/<?php echo $row->userID; ?>" class="btn btn-primary btn-xs"><i class="fa fa-lock"></i></a>
                                  <a href="<?php echo base_url();?>staff/edit/<?php echo $row->userID; ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>                                
							      <a href="<?php echo base_url();?>staff/view_profile/<?php echo $row->userID; ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
...
/* aoColumnDefs: [
 ...
 <script type="text/javascript">
        ...
        function status(did)
       {
           ...
           $.post("<?php echo base_url(); ?>staff/change_status/",{id:did},function(data)
           {     
